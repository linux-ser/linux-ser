    ...
    try {
        if (!sub) {
            ...
            try {
                ...
                await sock.sendMessage(chatId, { text: `ᴜꜱᴀɢᴇ: *.ᴀɴɪᴍᴜ <ᴛʏᴩᴇ>*\nᴛʏᴩᴇꜱ: ${apiTypes}` }, { quoted: message });
            } catch {
                await sock.sendMessage(chatId, { text: `ᴜꜱᴀɢᴇ: *.ᴀɴɪᴍᴇ <ᴛʏᴩᴇ>*\nᴛʏᴩᴇꜱ: ${supported.join(', ')}` }, { quoted: message });
            }
            return;
        }
